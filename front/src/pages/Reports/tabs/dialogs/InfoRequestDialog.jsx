...
import { Dialog, DialogTitle, DialogContent, TableContainer, Paper, Table, TableHead, TableRow, TableCell, TableBody,
 } from '@mui/material'
...
export default function InfoRequestDialog({ open, setOpen, title, dialogData }) {
