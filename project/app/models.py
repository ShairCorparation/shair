...
class Request(models.Model):
    ...
    address_of_dispatch = models.CharField(max_length=128, verbose_name='Адрес отправки')
    ...
    delivery_address = models.CharField(max_length=128, verbose_name='Адрес доставки')
    ...
    pallets = models.CharField(max_length=128, verbose_name='Палеты')
    yardage = models.CharField(max_length=128, verbose_name='Длина')
    width = models.CharField(max_length=128, verbose_name='Ширина')
    height = models.CharField(max_length=128, verbose_name='Высота')
    volume = models.CharField(max_length=128, verbose_name='Объем')
